    ...
    return (
        <div
            ...
            <div className={"w-full flex flex-row justify-between"}>
                <h2 className={"text-left text-clamping-mid font-exo font-extralight w-full"}>{headline}</h2>
                <input className={"font-exo text-clamping-sm border-2 border-gray-200 rounded-xl"} required={true} type="text"
