        ...
        <div
            ...
            <div
                ...
                <h3 className={"text-clamping-sm text-center w-full font-exo font-light opacity-55 truncate"}>Experiment
                    Trial Types</h3>
                <img src={penIcon} alt="pen/edit icon" onClick={()=>dispatch(setPopOver())}
                     className={"w-6 h-6 drop-shadow-md opacity-50 hover:opacity-100 transition-all duration-200 active:scale-125 "}/>
            </div>
            <div
                className={`w-[90%] flex flex-col overflow-y-scroll max-h-[30dvh] mb-5 justify-start items-center gap-3 ${isCollapsed ? "opacity-0 h-0" : "opacity-100 "}`}>
