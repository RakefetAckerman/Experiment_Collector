...
function BoxTrialTypes({experimentData, isCollapsed}: Props) {
    ...
    return (
        <div
            ...
            <h2 className={`font-exo font-bold text-clamping-sm truncate transition-all duration-500 ${!isCollapsed ? "opacity-0 h-0" : "opacity-100 -mb-10 "}`}>{trialTypes.length}</h2>
            <div
