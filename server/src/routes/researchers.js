...
/**
 * Route for getting users that have output on your experiment.
 * @name GET researchers/:email/:platform
 * @function
 * @param {Object} req - Express request object.
 * @param {Object} res - Express response object.
 ...
 * @throws {import("http-errors").HttpError} JSON response containing Http error message.
 */
router.get("/:email/:platform/createdBy", async (req, res) => {
    researchersController.getExperimentCreatedByResearcher(req, res);
});
